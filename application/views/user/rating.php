                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            Berikan rating atas pelayanan yang anda dapatkan.
                            <input hidden type="text" class="form-control form-control-user" id="file_surat_selesai" name='file_surat_selesai'
                                placeholder="file_surat_selesai" value="<?=$permohonan['file_surat_selesai']?>">
