...
<body>
    <center>
        ...
        <table border="0" width="650">
            <tr>
                <td colspan="4">
                    <center><u><b>SURAT KETERANGAN DOMISILI</b></u><br>
            ...
            <tr>
                <td>2.</td>
                <td colspan="3">Nama tersebut diatas adalah benar <b>Berdomisili</b> di Kelurahan Kuta Gambir,
                    Kecamatan Sidikalang Kabupaten Dairi sebagaimana diuraikan diatas.</td>
            </tr>
            <tr>
                <td>3.</td>
                <td colspan="3">Demikian Surat Keterangan ini diperbuat dengan sebenarnya untuk dapat dipergunakan seperlunya.
                </td>
            </tr>
