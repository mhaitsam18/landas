...
<head>
    <title>Surat Keterangan KK Hilang</title>
    <style>
        table tr td {
            font-size: 13px;
        }
...
<body>
    <center>
        ...
        <table border="0" width="650">
            <tr>
                <td colspan="4">
                    <center><u><b>SURAT KETERANGAN KK HILANG</b></u><br>
            ...
            <tr>
                <td>2.</td>
                <td colspan="3">Nama tersebut diatas menurut pengakuannya KK(Kartu Keluarga) dengan
                    nomor KK : <?= $surat['nik']; ?> miliknya hilang.</td>
            </tr>
            <tr>
                <td>3.</td>
